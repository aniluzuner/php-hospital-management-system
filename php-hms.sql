...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 05 Oca 2025, 15:51:00
...
(1, 'Hasan Fehmi Eryiğit', 50, 180, 80, 1),
...
(3, 'asd', 'asd', 12321312312, '', '', 0, 0, 0, '123');
...
INSERT INTO `muayene` (`muayene_id`, `muayene_doktor`, `muayene_tarih`, `muayene_klinik`, `mua_hs_id`) VALUES
(14, 'Eyşan Halenur', '2024-03-23', 'KULAK-BURUN-BOĞAZ HA', 1);
...
--
ALTER TABLE `hasta`
  MODIFY `hasta_id` bigint(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `muayene`
  MODIFY `muayene_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
